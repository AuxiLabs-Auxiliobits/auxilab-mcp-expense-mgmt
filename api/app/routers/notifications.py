...
_NOT_FOUND = {404: {"description": "Notification not found or not yours"}}
...
async def list_notifications(
    ...
    rows = notification_service.list_for(session, principal, include_archived=include_archived)
...
@router.post(
    "/{notification_id}/read", response_model=NotificationOut,
    summary="Mark one notification read", responses=_NOT_FOUND,
)
...
@router.post(
    "/{notification_id}/archive", response_model=NotificationOut,
    summary="Archive one notification", responses=_NOT_FOUND,
)
...
@router.delete(
    ...
    summary="Delete one notification", responses=_NOT_FOUND,
)
