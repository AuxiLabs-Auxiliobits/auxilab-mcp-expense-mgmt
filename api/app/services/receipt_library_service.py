...
from app.services import audit_service, malware_scan_service, sheet_service
...
def create(
    ...
    # Malware scan runs before magic-byte check: a PE/ELF file uploaded as .pdf must be
    # caught as malware, not as a format mismatch — the security signal is more accurate.
